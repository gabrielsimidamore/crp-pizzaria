# 🍕 Cardápio Digital — Pizzaria Família Silva

Cardápio digital responsivo (mobile-first) com carrinho, combos promocionais, order bumps e fechamento de pedido via WhatsApp. Zero dependências, um único arquivo HTML — deploy instantâneo na Vercel.
...
- Order bumps ("que tal completar o pedido?") no carrinho
